...
_smartsupp.key = 'b235b9f03ff826f79916a4707728cf29fcf53af8';
...
<body onclick="show_trans()" onscroll="show_trans()">
    <!-- loading -->
    <div id="loading">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="topbar-left">
                            <ul class="list-inline">
                                <li class="list-inline-item"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.60995 9.39382C11.9342 12.7171 12.6883 8.87243 14.8049 10.9875C16.8454 13.0275 18.0182 13.4362 15.4329 16.0208C15.109 16.281 13.0515 19.412 5.82067 12.1832C-1.41107 4.9535 1.71815 2.89387 1.97847 2.57012C4.57005 -0.0216324 4.97171 1.15798 7.01224 3.19794C9.1288 5.31391 5.28571 6.07051 8.60995 9.39382Z" stroke="#f9b707" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg> <?= $this->Util_model->get_option("site_phone"); ?></li>
                                <li class="list-inline-item ms-2"><svg width="16" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14.9188 6.37598L11.2161 9.38684C10.5165 9.94184 9.5322 9.94184 8.83262 9.38684L5.09863 6.37598" stroke="#f9b707" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.0906 16.5C16.625 16.507 18.3332 14.4246 18.3332 11.8653V6.14168C18.3332 3.58235 16.625 1.5 14.0906 1.5H5.90912C3.37466 1.5 1.6665 3.58235 1.6665 6.14168V11.8653C1.6665 14.4246 3.37466 16.507 5.90912 16.5H14.0906Z" stroke="#f9b707" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                     info@<?= $this->Util_model->get_option("site_url"); ?></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <li class="list-inline-item">
                                    <ul class="list-inline iq-left">
                                        <li class="list-inline-item  d-flex">
                                            ...
                                            <svg width="16" class="me-2" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.1772 9.01823H1.14307" stroke="#f9b707" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M8.7373 6.58838L11.1773 9.01838L8.7373 11.4484" stroke="#f9b707" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M5.08691 5.15756V4.38006C5.08691 2.68423 6.46108 1.31006 8.15775 1.31006H12.2277C13.9194 1.31006 15.2902 2.68089 15.2902 4.37256V13.6559C15.2902 15.3517 13.9152 16.7267 12.2194 16.7267H8.14858C6.45775 16.7267 5.08691 15.3551 5.08691 13.6642V12.8792" stroke="#f9b707" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>Sign In </a>
                                            <?php endif; ?>
                                        </li>
                                    </ul>
        ...
        <div class="iq-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="<?= base_url(); ?>assets/general/home-1.html"><img id="logo_img" class="img-fluid" src="<?= base_url(); ?>assets/general/images/logo-white.png" alt="logo"></a>
                        </div>
                        <nav> <a id="resp-menu" class="responsive-menu" href="<?= base_url(); ?>assets/general/javascript:void(0)"><i class="fa fa-reorder"></i> Menu</a>
        ...
        <div class="swiper-slide justify-content-around align-items-center">
            <div class="ban1-bgimg">
              ...
              <div class="banner-header">
                    <div class="iq-mb-20">
                        <h2 class="d-flex text-white" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay=".7">Your Best Moves Now!</h2>
                    ...
                    <small class="banner-dec" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay=".8" class="my-5 iq-mt-20">Discover boundless opportunities with our crypto investment platform. <br>Seamlessly navigate the dynamic world of digital assets, making informed decisions <br>has never been easier. Experience unparalleled security as you explore the future of finance. <br>Your best moves start here.</small>
                    <div class="iq-mt-20 d-flex banner-button" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay="1.3" class="iq-mt-20">
                        <?php if ($this->session->has_userdata(UID)) : ?>
                        ...
                        <?php else : ?>
                        <a href="<?= base_url(); ?>sign-up" class="button">
                            <span class="button-inner-box">
                            <span class="icon-one icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>
                            <span class="text-btn">Get Started</span>
                            <span class="icon-two icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>
                            </span>
                        </a>
                        <?php endif; ?>
              ...
              <div class="banner-img-1">
                 <img data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1.2" data-iq-delay="1.5" src="<?= base_url(); ?>assets/general/images/banner/03.png" alt="image">
              </div>
        </div>
        ...
        <div class="swiper-slide d-flex justify-content-around align-items-center">
            ...
            <div class="banner-header-3">
                <div class="banner-title-3 iq-mb-20">
                    <h2 data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay=".7" class="d-flex text-white">Be Ready to fly with</h2>
                    <h2 data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay=".7" class="banner-title d-flex"><?= SITE_TITLE; ?>.</h2>
                </div>
                <small class=" banner-dec" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="50" data-iq-duration="1" data-iq-delay="1">Unlock the potential of the digital frontier with <?= SITE_TITLE; ?>. <br>Our cutting-edge crypto investment platform empowers you to soar to new financial heights. <br>Seamlessly navigate the world of cryptocurrencies and seize opportunities for growth with confidence and ease.</small>
            ...
            <div class="banner-img-2">
                <img data-iq-gsap="onStart" data-iq-position-y="50" data-iq-position-y="-50" data-iq-duration="2" data-iq-delay="1"  src="<?= base_url(); ?>assets/general/images/banner/04.png" alt="image">
             </div>
        </div>
    </div>
...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                   ...
                   <div class=" iq-mb-70">
                        ...
                        <p>Start Investing Today with 3 Simple Steps on Our User-Friendly Platform. Your Journey Begins Here!</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <div class="icon mb-2"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/home/icon/03.png" alt=""></div>
                            <h4 class="mt-4 mb-3"><a href="<?= base_url(); ?>assets/general/javascript:void(0)">Create An Account</a></h4>
                            <p>Create your account quickly to access our crypto investment platform and seize new opportunities.</p>
                            <a href="<?= base_url(); ?>sign-up">Sign Up <i aria-hidden="true" class="ion-ios-arrow-forward"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <div class="icon mb-2"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/home/icon/01.png" alt=""></div>
                            <h4 class="mt-4 mb-3"><a href="<?= base_url(); ?>assets/general/javascript:void(0)">Fund Your Account</a></h4>
                            <p>Easily deposit funds into your account using a range of trusted payment methods, ensuring hassle-free transactions.</p>                                
                            <a href="<?= base_url(); ?>fund">Fund Account <i aria-hidden="true" class="ion-ios-arrow-forward"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <div class="icon mb-2"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/home/icon/02.png" alt=""></div>
                            <h4 class="mt-4 mb-3"><a href="<?= base_url(); ?>assets/general/javascript:void(0)">Invest Your Funds</a></h4>
                            <p>Put your money to work by exploring a diverse selection of our investment options.</p>                                
                            <a href="<?= base_url(); ?>forex-plan">Invest <i aria-hidden="true" class="ion-ios-arrow-forward"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Easy Steps -->
    <!-- About Us -->
    <section id="about" class="overview-block-ptb iq-bg iq-over-black-80 jarallax iq-about-us" style="background-image: url('<?= base_url(); ?>assets/general/images/bg/bg-13.jpg'); background-position: left center;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 iq-mb-80">
                    ...
                    <p class="text-white iq-mt-25">At <?= SITE_TITLE; ?>, we serve as your gateway to the exciting world of cryptocurrency investments. With our blend of expertise and innovation, we provide a secure and user-friendly platform for you to explore, invest, and nurture the growth of your digital assets. Join us on this transformative financial journey and be a part of shaping the future of global finance.</p>
                    <ul class="listing-hand text-white">
                        <li class="iq-mt-20">Registered under the UK Company House as a LLC</li>
                        <li class="iq-mt-20">Company registration number <?= $this->Util_model->get_option("cert_no"); ?></li><br>
                        <li class="iq-mt-20">Incorporated on <b><?= $this->Util_model->get_option("cert_date"); ?></b></li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 iq-about1 iq-mb-80" style="padding:0px;">
                    <div class="calculator white-bg" style="padding:0px;">
                        ...
                        <a href="<?= base_url(); ?>assets/certificate.pdf" target="_blank">
                            <img src="<?= base_url(); ?>assets/img/certificate.jpg" style="width:100%; height:auto;">
                        </a>
                        <a class="button mt-4 text-center" href="<?= $this->Util_model->get_option("cert_link"); ?>" target="_blank" style="width:100%">
                            <span class="button-inner-box">
                                <span class="icon-one icon"><svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg></span>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <p>Explore our array of distinctive features designed to elevate your crypto investment experience and unlock new opportunities in the ever-evolving digital landscape.</p>
                    </div>
                </div>
            </div>
            <div class="row h-100">
                <div class="col-lg-4 col-md-12 text-end">
                    <div class="d-flex align-items-center">
                        <div class="iq-feature2 iq-mtb-20">
                            <h4 class="mb-3" ><a href="<?= base_url(); ?>assets/general/services-details.html"> Swift Transactions</a></h4>
                            <p>Enjoy rapid and seamless cryptocurrency transactions, ensuring your investments respond to market opportunities promptly.</p>
                            </div>
                            <div class="ms-3">
                                <img class="img-fluid" src="<?= base_url(); ?>assets/general/images/services/icon/01.png" alt="">
                            </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="iq-feature2 iq-mtb-20">
                            <h4 class="mb-3" ><a href="<?= base_url(); ?>assets/general/services-details.html"> Robust Security</a></h4>
                            <p>Your investments are safeguarded by state-of-the-art measures, providing stability and peace of mind.</p>
                            </div>
                            <div class="ms-3">
                                <img class="img-fluid" src="<?= base_url(); ?>assets/general/images/services/icon/02.png" alt="">
                            </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="iq-feature2 iq-mtb-20">
                            <h4 class="mb-3" ><a href="<?= base_url(); ?>assets/general/services-details.html"> Exceptional ROI</a></h4>
                            <p>Experience enticing returns on investment, fueled by our strategic approach to crypto opportunities.</p>
                            </div>
                            <div class="ms-3">
                                <img class="img-fluid" src="<?= base_url(); ?>assets/general/images/services/icon/03.png" alt="">
                            </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 align-self-center text-center">
                    <img class="img-fluid" src="<?= base_url(); ?>assets/general/images/feature/features-img1.png" alt="">
                </div>
                <div class="col-lg-4 col-md-12">
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <img class="img-fluid" src="<?= base_url(); ?>assets/general/images/services/icon/04.png" alt="">
                        </div>
                        <div class="iq-feature2 iq-mtb-20">
                            <h4 class="mb-3"><a href="<?= base_url(); ?>assets/general/services-details.html">Intuitive Interface</a></h4>
                            <p>Our user-friendly platform simplifies investing, making your investing journey accessible to all levels of experience.</p>
                        </div>  
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <img class="img-fluid" src="<?= base_url(); ?>assets/general/images/services/icon/05.png" alt="">
                        </div>
                        <div class="iq-feature2 iq-mtb-20">
                            <h4 class="mb-3"><a href="<?= base_url(); ?>assets/general/services-details.html">Referral Rewards</a></h4>
                            <p>Invite others to join and earn rewards through our referral commission program, expanding your gains.</p>
                        </div>  
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <img class="img-fluid" src="<?= base_url(); ?>assets/general/images/services/icon/06.png" alt="">
                        </div>
                        <div class="iq-feature2 iq-mtb-20">
                            <h4 class="mb-3"><a href="<?= base_url(); ?>assets/general/services-details.html">24/7 Support</a></h4>
                            <p>Our dedicated support team is available around the clock to address your inquiries and ensure a smooth experience.</p>
                        </div>  
                    </div>
                </div>
                <div class="particles text-center"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/particles.png" alt=""></div>
            </div>
        </div>
    </section>
    <!-- Features -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    ...
                    <p>The cryptocurrency market continues to captivate global attention, with its dynamic and ever-changing landscape. As new projects emerge and established coins assert their dominance, investors are navigating a realm of potential and risk. The market's volatility remains a defining trait, prompting both excitement and caution. Regulatory developments, technological advancements, and shifting investor sentiment play pivotal roles in shaping its trajectory. Whether you're an enthusiast, trader, or investor, staying informed and adopting a strategic approach are essential in navigating the exciting yet unpredictable world of cryptocurrencies.</p>
    ...
    <!-- Bitcoin Charts -->
    <!-- Counter -->
    <section class="overview-block-ptb iq-bg iq-over-black-80 jarallax iq-we-happy" style="background-image: url('<?= base_url(); ?>assets/general/images/bg/bg-5.png'); background-position: center center;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <h2 class="text-white">We are the <span class="iq-font-yellow">best choice</span> for you because:</h2>
                    <ul class="listing-hand iq-mt-30 text-white">
                        <li class="iq-mt-20">Our system crafts personalized portfolios, optimizing your investments across a spectrum of assets to mitigate risk and enhance returns.</li>
                        <li class="iq-mt-20">Provides seamless navigation and intuitive controls, making managing your portfolio effortless for investors of all backgrounds.</li>
                        <li class="iq-mt-20">Backed by a track record of consistent performance, our system's strategies have delivered sustainable growth and stability, earning the trust of our satisfied clients.</li>
                    </ul>
                </div>
                <div class="col-lg-6 col-md-12 counter-blog">
                    <div class=" text-white">
                        <h3 class="title iq-mb-25 text-white">We're Fulfilled</h3>
                        <p>Empowering countless individuals like you, our system has been instrumental in staying ahead of financial commitments, ensuring stability and progress in an ever-evolving financial landscape.</p>
                    </div>
                    <div class="row">
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-6 col-md-12 ">
                    <div class="">
                        ...
                        <p>Outside our mouthwatering ROI, our users enjoy extra rewards in order to earn them more money.</p>
                    </div>
                    <div class="iq-feature3 iq-mt-60">
                        ...
                        <div class="fancy-content">
                            ...
                            <p>You will get <?= $this->Util_model->get_option("referral1"); ?>% of every investment by anyone you invited in the <?= SITE_TITLE; ?> platform.</p>
                        </div>
                    </div>
                    <div class="iq-feature3 iq-mtb-40">
                        ...
                        <div class="fancy-content">
                            ...
                            <p>You will get huge profit up to $75,000 when your networth (the total amount invested by your referrals) reaches a particular milestone.</p>
                        </div>
                    </div>
                    <div class="iq-feature3 iq-mb-80">
                        ...
                        <div class="fancy-content">
                            ...
                            <p>When you reinvest your capital after the duration of an investment, <?= $this->Util_model->get_option("reinvest_comm"); ?>% of the capital will be given to you as bonus.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <img src="<?= base_url(); ?>assets/general/images/about-us/about-img2.png" class="img-fluid" alt="#">
...
<img src="<?= base_url(); ?>assets/general/images/coin/01.png" class="img-fluid" alt="#">
</span>
...
<img src="<?= base_url(); ?>assets/general/images/coin/02.png" class="img-fluid" alt="#">
</span>
                        <span class="coin-03 animateme" data-when="span" data-from="0.9" data-to="0.1" data-translatex="50" data-translatey="-100">
<img src="<?= base_url(); ?>assets/general/images/coin/03.png" class="img-fluid" alt="#">
</span>
...
<img src="<?= base_url(); ?>assets/general/images/coin/04.png" class="img-fluid" alt="#">
</span>
...
<img src="<?= base_url(); ?>assets/general/images/coin/05.png" class="img-fluid" alt="#">
</span>
...
<img src="<?= base_url(); ?>assets/general/images/coin/06.png" class="img-fluid" alt="#">
</span>
                    </div>
                </div>
            </div>
    ...
    <!-- Team -->
    <!-- Plan -->
    <section id="plan" class="overview-block-ptb iq-bg iq-over-black-80 jarallax" style="background-image: url('<?= base_url(); ?>assets/general/images/bg/bg-7.jpg'); background-position: center center;">
        <div class="container">
            <div class="row" style="color:#ffffff;">
                <div class="col-lg-12 col-md-12 text-center">
                       ...
                       <div class="text-center iq-mb-70">
                            ...
                            <p class="mb-0">Explore Our Tailored Investment Plans for Your Financial Growth and Prosperity.</p>
                       </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="position-relative mb-4 mb-md-0">
                        ...
                        <div class="pricing-btn">
                            <button  type="submit" class="button <?php echo ($row["id"] == 3)?"bg-primary":""; ?> dark white rounded-pill text-uppercase"><?php echo strtoupper($row['name']); ?></button>
                        </div>
                        <div class="iq-pricing-detail text-center">
                            <p><i class="fa fa-dollar"></i><?php echo number_format($row['min_amt']); ?> - <i class="fa fa-dollar"></i><?php echo number_format($row['max_amt']); ?></p>
                            <hr>
                            <p style="margin-top:10px">Duration <?php echo $row['duration']; ?> Days <i class="fa fa-info-circle" title="The investment will last for a period of 120 forex days (Mon. to Fri.) before the you can cashout your capital" data-toggle="tooltip"></i></p>
                            <hr>
                            <p style="margin-top:10px">Capital Cashout <?php echo $row['cashout']; ?>% <i class="fa fa-info-circle" title="While cashing out your capital, you can only get <?php echo $row['cashout']; ?>% of the invested capital" data-toggle="tooltip"></i></p>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 text-center">
                    ...
                    <div class="text-center iq-mb-70">
                        ...
                        <p class="mb-0">We have provided the answers to the most common questions asked by our users in order to answer most of your questions.</p>
                    </div>
                    ...
                    <div id="accordion" role="tablist">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                <p style="margin-top: 20px;"><?php echo SITE_TITLE; ?> is a wealth management and capital investment company located in <?php echo $this->Util_model->get_option('site_address'); ?>. Incorporated in the year 2018.</p>
                                    <p style="margin-top: 20px;">We indulge ourselves with Real Estate Investment, Crypto Currency Investment, Forex Trading.</p>
                                    <p style="margin-top: 20px;"><?php echo SITE_TITLE; ?> allow investors to participate and benefit from the company using cryptocurrency as mode of payment.</p>
                                    <p style="margin-top: 20px;"><?php echo SITE_TITLE; ?> have three(4) major investment packages; All packages mature within the package interval</p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    <p>To get started with <?php echo SITE_TITLE; ?>, simply navigate or click on <a href="<?php echo base_url(); ?>sign-up">Sign Up</a> fill in your details. >>> verify your email address and login to your dashbaord.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                <div class="card-body">
                                    <p>To deposit into your <?php echo SITE_TITLE; ?> account follow the steps below:</p>
                                    <ol>
                                        <li>Sign into your account</li>
                                        <li>Click the <a href="<?php echo base_url(); ?>fund"><b>Fund Account</b></a> link</li>
                                        <li>Enter the amount you wish to deposit and proceed</li>
                                        <li>Copy the wallet address or scan the QR code and send the bitcoin to it</li>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="headingFive" data-parent="#accordion">
                                <div class="card-body">
                                    <p>In <?php echo SITE_TITLE; ?> withdrawal interval depends on the plan of your investment. You will always have continuous withdrawal as long as you have active investment in the system.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Faq's -->
    <!-- Contact Us -->
    <section id="contact" class="overview-block-ptb iq-bg iq-over-black-80 jarallax" style="background-image: url('<?= base_url(); ?>assets/general/images/bg/bg-2.jpg'); background-position: center center;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-8 text-center iq-need-help">
                    ...
                    <ul class="list-inline iq-mt-60 mb-4">
                        <li class="list-inline-item iq-font-yellow"><i class="fa fa-phone me-2" aria-hidden="true"></i> <?= $this->Util_model->get_option("site_phone"); ?></li>
                        <li class="list-inline-item text-white ms-3"><i class="fa fa-envelope-open me-2" aria-hidden="true"></i>info@<?= $this->Util_model->get_option("site_url"); ?></li>
                    </ul>
                    <div class="text-white iq-mt-10">Our trained and dedicated team of support are available 247 to answer your questions and assist you in case of any difficulty on the live chat.</div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row ">
                <div class="col-lg-12 col-md-12 ">
                    <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="false" data-items="5" data-items-laptop="4" data-items-tab="3" data-items-mobile="2" data-items-mobile-sm="1" data-margin="30">
                        <div class="item"> <a href="<?= base_url(); ?>assets/general/clients.html"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/clients/white/mastercard-1.png" alt="#"></a></div>
                        <div class="item"> <a href="<?= base_url(); ?>assets/general/clients.html"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/clients/white/visa.png" alt="#"></a></div>
                        <div class="item"> <a href="<?= base_url(); ?>assets/general/clients.html"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/clients/white/paypal.png" alt="#"></a></div>
                        <div class="item"> <a href="<?= base_url(); ?>assets/general/clients.html"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/clients/white/comodo-secure.png" alt="#"></a></div>
                        <div class="item"> <a href="<?= base_url(); ?>assets/general/clients.html"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/clients/white/bitcoin.png" alt="#"></a></div>
                        <div class="item"> <a href="<?= base_url(); ?>assets/general/clients.html"><img class="img-fluid" src="<?= base_url(); ?>assets/general/images/clients/white/commission.png" alt="#"></a></div>
...
<footer class="iq-footer dark-bg iq-footer-2">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 iq-mtb-90">
                    <div class="logo">
                        <img id="logo_img_2" class="img-fluid" src="<?= base_url(); ?>assets/general/images/logo-white.png" alt="# ">
                        <div class="text-white iq-mt-25 ">Partnering with us ensures your daily cryptocurrency profits, backed by our expertise and commitment to financial growth.</div>
                        <ul class="iq-media-blog iq-mt-30 float-start">
                            <li><a href="<?= base_url(); ?>assets/general/javascript:void(0)" class="rounded" ><i class="fa fa-twitter"></i></a></li>
                            <li><a href="<?= base_url(); ?>assets/general/javascript:void(0)" class="rounded"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="<?= base_url(); ?>assets/general/javascript:void(0)" class="rounded"><i class="fa fa-instagram"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12  iq-contact iq-mtb-90 footer-menu-list">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <ul class="iq-pl-0 ">
                            <li><a href= "#about"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>About Us</a></li>
                            <li><a href="#feature"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Features</a></li>
                            <li><a href="#market"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Market</a></li>
                            <li><a href="#plan"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Plan</a></li>
                            <li><a href="#faq"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>FAQ</a></li>
                            <li><a href="#contact"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Contact Us</a></li>
                        </ul>
                        <ul class="ms-5">
                            <li><a href="<?= base_url(); ?>home"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>My Account</a></li>
                            <li><a href="<?= base_url(); ?>fund"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Deposit</a></li>
                            <li><a href="<?= base_url(); ?>forex-plan"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Invest</a></li>
                            <li><a href="<?= base_url(); ?>withdraw"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Withdraw</a></li>
                            <li><a href="<?= base_url(); ?>fund-list"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>Transactions</a></li>
                            <li><a href="<?= base_url(); ?>info"><i class="fa fa-angle-right me-2" aria-hidden="true"></i>My Profile</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 iq-contact iq-mtb-90">
                    ...
                    <div class="iq-mb-30">
                        <div class="blog"><i class="ion-ios-telephone-outline"></i>
                            <div class="content ">
                                <div class=" title ">Phone</div> <?= $this->Util_model->get_option("site_phone"); ?></div>
                        </div>
                    </div>
                    <div class="iq-mb-30">
                        <div class="blog "><i class="ion-ios-email-outline"></i>
                            <div class="content ">
                                <div class=" title ">Mail</div> info@<?= $this->Util_model->get_option("site_url"); ?></div>
                        </div>
                    </div>
                    <div class="blog"><i class="ion-ios-location-outline"></i>
                        <div class="content ">
                            <div class=" title ">Address</div> <?= $this->Util_model->get_option("site_address"); ?></div>
                    </div>
                </div>
    ...
    <div id="trans-wrap2" style="display: block">
                    ...
                    <div><a target="_blank" href="https://wa.link/yhrllz"><img src="assets/img/WhatsApp.svg.webp" height="50" width="50"></a></div>
                </div>
    <div class="footer-bottom iq-ptb-20 ">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <div class="iq-copyright iq-mt-10 text-white text-center">&copy; Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="#"><?= SITE_TITLE; ?></a> All Rights Reserved </div> 
                </div>
            </div>
        </div>
    </div>
...
<!-- back-to-top -->
<div id="back-to-top">
    <a class="top" id="top" href="<?= base_url(); ?>assets/general/#top"> <i class="ion-ios-upload-outline"></i> </a>
</div>
<!-- back-to-top End -->
